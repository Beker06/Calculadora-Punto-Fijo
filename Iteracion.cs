...
{
    public partial class Iteracion : Form
    {
        public Iteracion()
        {
            InitializeComponent();
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 1; i < Lim + 1; i++)/*Ciclo donde se realizan los calculos y se insertan datos en el DataGridView*/
                {
                    ...
                    if (i >= 2)/*Cuando la iteracion sea igual o mayor que 2 se empieza a calcular el error*/
                    {
                        ...
                        double er = ((Math.Abs(X - Xi)) / Math.Abs(X)) * 100;/*Se calcula el error*/
        ...
        private void Iteracion_Load(object sender, EventArgs e)
        {
